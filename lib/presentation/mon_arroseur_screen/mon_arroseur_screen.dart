...
class MonArroseurScreen extends StatelessWidget {
  MonArroseurScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<MonArroseurBloc>(
        create: (context) => MonArroseurBloc(
            MonArroseurState(monArroseurModelObj: MonArroseurModel()))
          ..add(MonArroseurInitialEvent()),
        child: MonArroseurScreen());
  }
                      ...
                      SizedBox(
                          ...
                          child: Stack(
                              ...
                              children: [
                                ...
                                CustomImageView(
                                    imagePath:
                                        ImageConstant.imgCasuallife3d285x250,
                          ...
                          child: Row(
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: Text("msg_tat_de_l_arrosage".tr,
                                ...
                                BlocSelector<MonArroseurBloc, MonArroseurState,
                                    ...
                                    builder: (context, isSelectedSwitch) {
                                      return CustomSwitch(
                                          ...
                                          onChanged: (value) {
                                            context.read<MonArroseurBloc>().add(
                                                ChangeSwitchEvent(
                                                    value: value));
                                          });
                                    })
                          ...
                          child: Row(
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: Text("msg_programme_d_arrosage".tr,
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                                        style: AppStyle.txtParagraphe)),
                                CustomIconButton(
                                    ...
                                    width: 38,
                                    variant:
                                        IconButtonVariant.OutlineBlack90033_2,
                      ...
                      Container(
                          ...
                          child: Row(
                              ...
                              children: [
                                Padding(
                                    padding: getPadding(top: 12, bottom: 10),
                                    child: Text("msg_heure_d_arrosage".tr,
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                                        style: AppStyle.txtParagraphe)),
                                CustomIconButton(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          SizedBox(
                                              ...
                                              child: Text(
                                                  "msg_temp_rature_interieure2"
                                                      .tr,
                                                  maxLines: null,
                                                  textAlign: TextAlign.left,
                                                  style:
                                                      AppStyle.txtParagraphe)),
                                          Align(
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomIconButton(
                                    ...
                                    variant:
                                        IconButtonVariant.OutlineBlack90033_1,
