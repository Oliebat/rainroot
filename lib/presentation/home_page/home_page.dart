                      ...
                      CustomAppBar(
                        ...
                        title: Row(
                          children: [
                            ...
                            Padding(
                              padding:
                                  getPadding(left: 51, top: 40, bottom: 38),
                              child: Text(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          CustomImageView(
                                            ...
                                            margin:
                                                getMargin(top: 10, bottom: 14),
                                          ),
                                          Container(
                                            width: getHorizontalSize(137),
                                            margin:
                                                getMargin(top: 19, bottom: 31),
                                            child: Text(
